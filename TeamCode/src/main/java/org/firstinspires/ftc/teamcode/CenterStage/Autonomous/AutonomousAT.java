...
@Autonomous(name="AutonomousAT", group="Autonomos")
public class AutonomousAT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            SideWalk(0.0237, 8, 1, 0.2);
            sleep(500);
            Reto(0.025, 195, 0.35);
            sleep(500);
            SideWalk(0.0237, 50, 1, 0.22); //0
            ElbowUp(1, 0, -0.5, 2700);
            Reto(0.025, -15, 0.2);
            ...
            Reto(0.025, 5, 0.2);
            SideWalk(0.0237, -20, 0, 0.2);
            Pinça(1, 0, 0, 1, 1, 0);
            sleep(1000);

            Pinça(1, 1, 0, 1, 1, 0);
            ElbowUp(0, 1, -0.35, 350);
            Reto(0.025, 10, 0.2);

            SideWalk(0.0237, 72, 1 , 0.2);
            Reto(0.25, -20, 0.2);
