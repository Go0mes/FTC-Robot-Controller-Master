...
@Autonomous(name="AutonomousTestv0_9", group="Autonomos")
public class AutonomousTestv0_9 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() ) {
            ...
            WalkTimer(0.2, 0.2,0.2, 0.2, 2000);
    ...
    public void Giro(double tolerance, double degrees, double powMDF, double powMDT, double powMEF, double powMET){
    ...
    public void Straight(double ganho, double powMDF, double powMDT, double powMEF, double powMET, double distancecm){
        ...
        int distancet = (int) ((69000/100)*distancecm);
