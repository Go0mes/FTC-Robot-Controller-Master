...
@Autonomous(name="TestesAuto_AZUL_TRAS", group="Autonomos")
public class TestesAuto_AZUL_TRAS extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            sleep(12000);
            SideWalk(0.07, -7, 0, 0.2);
            WalkTimer(0, 0, 0, 0, 3, 0.05);
            sleep(500);
            Reto(0.025, -195, 0.33);
            sleep(500);
            SideWalk(0.0237, -40.95, 0, 0.29);
            ElbowUp(1, 0, -0.43, 2700);
            //   Reto(0.025, -14, 0.2);
            WalkTimer(-0.2, -0.2, -0.2, -0.2, 2, 0.0237);
            ...
            SideWalk(0.0237, -48, 0 , 0.35);
            Reto(0.025, -30, 0.2);


            //  SideWalk(0.0237, 70, 1 , 0.35);
            // Reto(0.025, -26, 0.25);
    ...
    public void WalkTimer(double powMDF, double powMDT, double powMEF, double powMET, float duration, double ganho) {
