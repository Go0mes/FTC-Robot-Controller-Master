...
@Autonomous(name="VERMELHO_FRENTE_AUTO", group="Autonomos")
public class VERMELHO_FRENTE_AUTO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            SideWalk(0.0237, 1.5, 1, 0.29);
            Reto(0.025, -60, 0.33);
            sleep(350);
            SideWalk(0.0237, 50.5, 1, 0.29);
