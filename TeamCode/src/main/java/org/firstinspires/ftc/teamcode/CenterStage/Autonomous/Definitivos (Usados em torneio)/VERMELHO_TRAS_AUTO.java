...
@Autonomous(name="VERMELHO_TRAS_AUTO", group="Autonomos")
public class VERMELHO_TRAS_AUTO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // sleep(15000);
            SideWalk(0.07, 7, 1, 0.4);
            //WALKTIMER CORREÇÃO
            WalkTimer(0, 0, 0, 0, 1, 0.05);
            sleep(500);
            Reto(0.07, -190, 0.5);
            sleep(500);
            SideWalk(0.0237, 40.95, 1, 0.29);
            ElbowUp(1, 0, -0.43, 2700);
            //   Reto(0.025, -14, 0.2);
            WalkTimer(-0.2, -0.2, -0.2, -0.2, 1, 0.0237);
