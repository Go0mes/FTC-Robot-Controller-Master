...
@Autonomous(name="AutonomousTestv0_6", group="Autonomos")
public class AutonomousTestv0_6 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() ) {
            ...
            while (MDT.getCurrentPosition() < 69000){
    ...
    public void Telemetry() {
        ...
        telemetry.addData("MDT Posi", MDF.getCurrentPosition());
